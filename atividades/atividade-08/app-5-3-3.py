...
def main():
    ...
    create_escritorio(connection, 1, "Fortaleza", "85912345678", "Av. Doutor Taveira, 530", None, "Ceará", "Brasil", 60110101, "Siqueira")
    create_linha_produtos(connection, 1, "Calças da China", None, None)
    create_funcionario(connection, 1, 1, "Marina", "Silva", None, "marina.silva07@aluno.ifce.edu.br", None, "Designer chefe")
    create_produto(connection, 1, "Calça Low Moss", 1, None, "China", "Calça", 245, 500, 80,)
    create_cliente(connection, 1, "Yasmin", "Sousa", "Yasmin", "85987654321", "R. Maria da Conceição", None, "Fortaleza", "Ceará", 48288970, "Brasil", 1, 200)
